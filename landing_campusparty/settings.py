# Django settings for landing_campusparty project.
import os
...
SECRET_KEY = os.environ['LANDING_CAMPUSPARTY_SECRET_KEY']
...
ROOT_URLCONF = 'landing_campusparty.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'landing_campusparty.wsgi.application'
